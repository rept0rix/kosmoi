...
export const getCategoryIcon = (category) => {
    ...
    if (category === 'handyman' || category === 'carpenter' || category === 'electrician' || category === 'plumber') {
        ...
        scale = 1.2;
    } else if (category === 'cleaning' || category === 'pest_control') {
        // Sparkle/Clean shape
        path = "M12 22c4.97 0 9-4.03 9-9-4.97 0-9-4.03-9-9-4.97 0-9 4.03-9 9 0 4.97 4.03 9 9 9zm0-16c3.87 0 7 3.13 7 7s-3.13 7-7 7-7-3.13-7-7 3.13-7 7-7z"; // Simple circle for now, can be improved
        scale = 1.5;
    } else if (category === 'taxi' || category === 'moving') {
        // Car/Transport shape
