...
export default function OneDollar() {
  ...
  useEffect(() => {
    AnalyticsService.oneDollar.pageViewed();
  }, []);

  const handleCheckout = async () => {
    setLoading(true);
    // Track checkout click
    AnalyticsService.oneDollar.checkoutClicked();
    try {
        ...
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          >
            ...
            <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
              Stop guessing. See exactly who is looking for your services on Koh
              Samui right now. Unlock full "Island Pro" status for 14 days.
            </p>
      ...
      <section className="py-20 bg-gradient-to-b from-[#0A0F1C] to-teal-900/10">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-lg text-slate-300 mb-8">
            We know you've been burned by marketing agencies before. We want to
            prove Kosmoi works before asking for a real subscription. <br />
            <br />
            For the price of a 7-Eleven coffee, you can see the live demand for
            your business.
          </p>
          <Button
            onClick={handleCheckout}
