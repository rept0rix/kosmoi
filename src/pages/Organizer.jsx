...
export default function Organizer() {
    ...
    const items = [
        { title: 'Trip Planner', desc: 'Manage your itinerary', icon: Luggage, color: 'text-blue-600 bg-blue-100', delay: 'delay-[0ms]', path: '/tripplanner' },
        { title: 'My Calendar', desc: 'Upcoming events & bookings', icon: Calendar, color: 'text-purple-600 bg-purple-100', delay: 'delay-[100ms]', path: '/vendor/calendar' },
        { title: 'Tasks', desc: 'To-do list & reminders', icon: CheckSquare, color: 'text-green-600 bg-green-100', delay: 'delay-[200ms]', path: '/admin/tasks' }
    ];
