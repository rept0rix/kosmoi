...
export default function Organizer() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 p-4 md:p-8 font-sans animate-in fade-in duration-500 pb-24">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold font-['Outfit'] text-white flex items-center gap-3">
              ...
              {t("organizer.title") || "Trip Organizer"}
            </h1>
        ...
        >
          <TabsList className="grid w-full grid-cols-5 h-auto p-1 bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl">
            <TabsTrigger
              value="overview"
          ...
          <div className="min-h-[500px]">
            ...
            >
              <div className="rounded-3xl border border-slate-800 overflow-hidden bg-slate-900 shadow-sm">
                <TripPlanner
                  activeTrip={activeTrip}
            ...
            <TabsContent
              ...
              className="mt-0 focus-visible:outline-none"
            >
              <div className="rounded-3xl border border-slate-800 overflow-hidden bg-slate-900 shadow-sm min-h-[60vh]">
                <MyBookings />
              </div>
            </TabsContent>
