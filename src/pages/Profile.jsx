        ...
        <Card className="max-w-md w-full bg-white/95 backdrop-blur-sm shadow-2xl">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              התחבר כדי לגשת לפרופיל שלך, לשמור מועדפים ולכתוב ביקורות
            </p>
            <Button
              onClick={handleLogin}
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h2 className="text-2xl font-bold text-gray-900">{user?.full_name || "משתמש"}</h2>
                  {user?.role === "admin" && (
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-900 font-medium">הביקורות שלי</span>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-900 font-medium">מועדפים</span>
                </div>
                <ChevronLeft className="w-5 h-5 text-gray-400" />
              </button>
              <button
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-900 font-medium">חיפושים אחרונים</span>
                </div>
                <ChevronLeft className="w-5 h-5 text-gray-400" />
              </button>
            </div>
            ...
            {myBusiness && myBusiness.length > 0 ? (
              ...
              <div>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                  <h4 className="font-semibold text-blue-900 mb-2">למה לרשום עסק?</h4>
                  <ul className="text-sm text-blue-800 space-y-1">
                    <li>• הופע בתוצאות החיפוש ובמפה</li>
                    <li>• קבל ביקורות מלקוחות</li>
                    <li>• הגדל את החשיפה שלך</li>
                    <li>• התחבר ללקוחות חדשים</li>
                  </ul>
                </div>
                <Button
                  onClick={() => navigate(createPageUrl("BusinessRegistration"))}
            ...
            <div className="space-y-1">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-900">עריכת פרופיל</span>
                </div>
              ...
              <button className="w-full flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-900">שפה</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-500">עברית</span>
                  <ChevronLeft className="w-4 h-4 text-gray-400" />
                </div>
              </button>
              <button className="w-full flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-900">נגישות</span>
                </div>
                <ChevronLeft className="w-4 h-4 text-gray-400" />
              </button>
              <button className="w-full flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-900">יצירת קשר</span>
                </div>
                <ChevronLeft className="w-4 h-4 text-gray-400" />
              </button>
            </div>
