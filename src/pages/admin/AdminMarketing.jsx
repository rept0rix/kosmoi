...
const AdminMarketing = () => {
  ...
  const handleRunDave = async () => {
    ...
    try {
      ...
      const input =
        "Find a trending travel topic for Koh Samui and generate an Instagram post for it.";
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      toast({
        title: "Post Failed",
        description: "Could not publish content.",
        variant: "destructive",
      });
    } finally {
      setIsPosting(false);
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card className="bg-gradient-to-br from-purple-50 to-white border-purple-100">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-gray-600">
                Dave is ready to scrape trends and generate viral content for
                you.
              </p>
              <Button
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base text-gray-500 uppercase tracking-wide">
                Recent Posts
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {history.length === 0 ? (
                ...
                history.map((post) => (
                  ...
                  >
                    <div
                      className={`p-2 rounded-full ${post.platform === "instagram" ? "bg-pink-100 text-pink-600" : "bg-gray-200"}`}
                    >
            ...
            {agentOutput && (
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <h4 className="font-medium text-xs uppercase tracking-wider text-gray-500">
                    Thought Stream
                  </h4>
