...
const AdminMarketing = () => {
    ...
    const handleRunDave = async () => {
        ...
        try {
            ...
            // Try to parse the "output" if it's JSON-like or just use it
            // Dave's AgentRunner pipeline returns text in 'output' currently
            // We might want to parse it if we structured it
        } catch (error) {
            console.error(error);
    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* Control Panel */}
                <Card className="lg:col-span-1 bg-gradient-to-br from-purple-50 to-white border-purple-100">
                    <CardHeader>
