            ...
            <div className="p-8 space-y-8">
                ...
                <Tabs defaultValue="live" className="w-full">
                    <TabsList className="bg-slate-900/50 border border-white/5 p-1">
                        <TabsTrigger value="tasks" className="data-[state=active]:bg-purple-600 border-r-2 border-white/10">My Tasks</TabsTrigger>
                        <TabsTrigger value="live" className="data-[state=active]:bg-emerald-600 font-bold">Live Ops</TabsTrigger>
