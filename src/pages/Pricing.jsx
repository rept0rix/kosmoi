      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight text-white drop-shadow-xl font-heading">
            Simple,{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-banana-400 to-banana-600 animate-pulse">
              Transparent
            </span>{" "}
            Pricing
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          ...
          <div className="glass-card-premium p-6 md:p-8 rounded-3xl flex flex-col hover:border-banana-500/30 transition-all duration-300">
            <div className="mb-8">
              <h3 className="text-lg font-bold text-slate-300 mb-2 font-heading">
                Basic
              </h3>
          ...
          <div className="glass-card-premium p-6 md:p-8 rounded-3xl flex flex-col border-banana-400/30 shadow-gold-glow hover:scale-[1.02] transition-all relative overflow-hidden group">
            ...
            <div className="mb-8 relative z-10">
              <h3 className="text-lg font-bold text-banana-200 mb-2 font-heading">
                Test Drive
              </h3>
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-banana-400">
                  ฿35
                </span>
            ...
            <button
              ...
              className="relative z-10 w-full py-3 px-4 bg-gradient-to-r from-banana-500 to-banana-600 text-midnight-950 rounded-xl font-bold hover:shadow-lg hover:shadow-banana-500/40 transition-all font-heading tracking-wide disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
          ...
          <div className="glass-card-premium p-6 md:p-8 rounded-3xl flex flex-col hover:border-blue-400/30 transition-all duration-300">
            <div className="mb-8">
              <h3 className="text-lg font-bold text-blue-200 mb-2 font-heading">
                Growth
              </h3>
              <div className="flex items-baseline gap-1">
          ...
          <div className="glass-card-premium p-6 md:p-8 rounded-3xl flex flex-col relative transform md:-translate-y-4 border-purple-500/30 bg-purple-900/10 hover:bg-purple-900/20 transition-all">
            ...
            <div className="mb-8">
              <h3 className="text-lg font-bold text-purple-200 mb-2 font-heading">
                Scale
              </h3>
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-white">
        ...
        <div className="mt-24 max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-white text-center mb-12 font-heading">
            Compare Plans
          </h2>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/10 bg-white/5">
                  ...
                  <th className="p-6 text-banana-400 font-bold text-center bg-banana-500/10">
                    Test Drive
                    <br />
              ...
              <tbody className="divide-y divide-white/5">
                ...
                <tr>
                  ...
                  <td className="p-4 text-center bg-banana-500/5">
                    <Check className="w-5 h-5 text-banana-400 mx-auto" />
                  </td>
                  <td className="p-4 text-center">
                ...
                <tr>
                  ...
                  <td className="p-4 text-center bg-banana-500/5">
                    <CheckCircle className="w-5 h-5 text-banana-400 mx-auto" />
                  </td>
                  <td className="p-4 text-center">
                ...
                <tr>
                  ...
                  <td className="p-4 text-center bg-banana-500/5">
                    <span className="text-banana-400 font-medium">Boosted</span>
                  </td>
                  <td className="p-4 text-center">
                ...
                <tr>
                  ...
                  <td className="p-4 text-center bg-banana-500/5">
                    <span className="text-banana-400 font-medium">
                      Priority
                    </span>
                  </td>
                  <td className="p-4 text-center">
                ...
                <tr>
                  ...
                  <td className="p-4 text-center bg-banana-500/5 text-sm text-banana-200">
                    Demo (1 chat)
                  </td>
                ...
                <tr>
                  ...
                  <td className="p-4 text-center bg-banana-500/5 text-sm">
                    2-week History
                  </td>
                ...
                <tr>
                  <td className="p-4 pl-6 text-slate-300">
                    Booking Commission
                    <div className="text-xs text-banana-400 font-medium mt-1">
                  ...
                  <td className="p-4 text-center bg-banana-500/5">
                    <span className="text-banana-400 font-bold">0%</span>
                  </td>
