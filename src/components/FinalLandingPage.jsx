...
const FinalLandingPage = () => {
  ...
  const handleCTA = () => {
    // Open WhatsApp for immediate conversion
    // Replace with actual business number when available
    window.open('https://wa.me/66000000000?text=I%20am%20interested%20in%20the%20One%20Dollar%20Challenge', '_blank');
  };
